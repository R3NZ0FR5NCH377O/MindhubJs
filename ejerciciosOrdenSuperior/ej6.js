function buscarCervezaPorNombre(cervezas, nombreBuscado) {
    const cervezaEncontrada = cervezas.find((cerveza) => cerveza.nombre === nombreBuscado);
  ...
  const nombreBuscado = "Cerveza5"; 
  
  const cervezaEncontrada = buscarCervezaPorNombre(cervezas, nombreBuscado);
